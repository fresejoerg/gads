...
- `test_score` tol 0.005 is a **placeholder pending repeat-run verification**: the deterministic
  portfolio exists precisely so this can become `exact: true`. Tighten after the local/hybrid
  reference runs land and match.
